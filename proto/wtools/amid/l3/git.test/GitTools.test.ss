...
function repositoryClone( test )
{
  ...
  if( Config.debug )
  {
    begin().then( () =>
    {
      ...
      test.case = 'extra arguments';
      var o = { localPath : a.abs( 'wModuleForTesting1' ), remotePath : 'https://github.com/Wandalen/wRepoBasic' };
      test.shouldThrowErrorSync( () => _.git.repositoryClone( o, o ) );

      test.case = 'wrong type of options map o';
      var o = [ a.abs( 'wModuleForTesting1' ), 'https://github.com/Wandalen/wRepoBasic' ];
      test.shouldThrowErrorSync( () => _.git.repositoryClone( o ) );

      test.case = 'unknown option in options map o';
      var o = { localPath : a.abs( 'wModuleForTesting1' ), remotePath : 'https://github.com/Wandalen/wRepoBasic', unknown : 1 };
      test.shouldThrowErrorSync( () => _.git.repositoryClone( o ) );

      test.case = 'o.localPath is not defined string';
      var o = { localPath : '', remotePath : 'https://github.com/Wandalen/wRepoBasic' };
      test.shouldThrowErrorSync( () => _.git.repositoryClone( o ) );
      ...
      var o =
      {
        ...
        remotePath : 'https://github.com/Wandalen/wRepoBasic'
      };
      test.shouldThrowErrorSync( () => _.git.repositoryClone( o ) );
